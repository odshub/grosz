export const dictionaries = {
  uk: {
    ...
    'page.free_money': 'Вільні гроші',

    // Meters
    'nav.meters': 'Лічильники',
    'meters.title': 'Лічильники',
    'meters.empty': 'Немає лічильників',
    'meters.add': 'Додати лічильник',
    'meters.name': 'Назва',
    'meters.name_placeholder': 'Напр. Електроенергія, Газ',
    'meters.unit': 'Одиниця виміру',
    'meters.unit_placeholder': 'Напр. кВт, м³',
    'meters.price': 'Тариф',
    'meters.add_reading': 'Додати показник',
    'meters.prev_reading': 'Попередній показник',
    'meters.current_reading': 'Поточний показник',
    'meters.diff': 'Різниця',
    'meters.total_cost': 'Сума до оплати',
    'meters.date': 'Дата (Місяць)',
    'meters.saving': 'Збереження...',
    'meters.history': 'Історія показників',
    'meters.no_history': 'Ще немає показників',
    'meters.delete_confirm': 'Дійсно видалити?',
    'meters.validation_reading_less': 'Поточні показники не можуть бути меншими за попередні!',
    'meters.all_records': 'Всі записи',
    'meters.nothing_found': 'Нічого не знайдено',
  ...
  ru: {
    ...
    'page.free_money': 'Свободные деньги',

    // Meters
    'nav.meters': 'Счетчики',
    'meters.title': 'Счетчики',
    'meters.empty': 'Нет счетчиков',
    'meters.add': 'Добавить счетчик',
    'meters.name': 'Название',
    'meters.name_placeholder': 'Напр. Электричество, Газ',
    'meters.unit': 'Единица измерения',
    'meters.unit_placeholder': 'Напр. кВт, м³',
    'meters.price': 'Тариф',
    'meters.add_reading': 'Добавить показание',
    'meters.prev_reading': 'Предыдущее показание',
    'meters.current_reading': 'Текущее показание',
    'meters.diff': 'Разница',
    'meters.total_cost': 'Сумма к оплате',
    'meters.date': 'Дата (Месяц)',
    'meters.saving': 'Сохранение...',
    'meters.history': 'История показаний',
    'meters.no_history': 'Пока нет показаний',
    'meters.delete_confirm': 'Действительно удалить?',
    'meters.validation_reading_less': 'Текущие показания не могут быть меньше предыдущих!',
    'meters.all_records': 'Все записи',
    'meters.nothing_found': 'Ничего не найдено',
